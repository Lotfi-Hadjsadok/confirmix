        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
            <span>
                ...
                @if ($paginator->onFirstPage())
                    <span
                        class="relative inline-flex items-center px-4 py-2 text-sm font-medium leading-5 text-gray-500 bg-white border border-gray-300 rounded-md cursor-default dark:text-gray-600 dark:bg-gray-700 dark:border-gray-600">
                ...
                @else
                    ...
                    @else
                        <button type="button" wire:click="previousPage('{{ $paginator->getPageName() }}')"
                            ...
                            class="relative inline-flex items-center px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md focus:outline-none focus:ring ring-blue-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 dark:bg-primary dark:border-primary dark:text-gray-300 dark:active:bg-primary dark:active:text-gray-300">
                            {!! __('pagination.previous') !!}
                        </button>
                    @endif
                @endif
