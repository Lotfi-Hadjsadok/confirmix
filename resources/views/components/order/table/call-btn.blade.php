    <td class="text-sm text-gray-800 size-px whitespace-nowrap dark:text-neutral-200">
        <div class="py-3 ps-6 lg:ps-3 xl:ps-0 pe-6">
            <div class="flex items-center gap-x-3">
                <button {{ !in_array($order->status, ['confirmed', 'cancelled', 'not_delivered']) ? 'disabled' : '' }}
                    class="p-2 rounded-full cursor-pointer {{ !in_array($order->status, ['confirmed', 'cancelled', 'not_delivered']) ? 'bg-primary animate-heartbeat hover:bg-primary/70' : 'bg-gray-600' }} size-9 "><svg
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7319.000000)"
                                    fill="#ffffff">
